...
public class TimeSlotDAO {
    ...
    private static final String SAVE =
            "INSERT INTO time_slot (tutor_id, date, start_time, end_time, available) " +
                    "VALUES (?, ?, ?, ?, TRUE)";
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    if (name != null && surname != null) {
                        bean.setBookedByName(name + " " + surname);
                    }
